...
const SpinnerPrint = () => {
    ...
    const handleCopy = () => {
        setCopy(true);
        navigator.clipboard.writeText("<Spinner />");
    ...
    return (
        <div className="cod-back flex-center loaderCopy" onClick={handleCopy}>
            <pre>
                <code>
                    <p><span className="cod-gray">{'<'}</span><span className="cod-green">Spinner</span> <span className='cod-gray'>{'/>'}</span></p>
                </code>
            </pre>
